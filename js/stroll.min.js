 ...
 */
(function(){var h=500;
var b= false/*!!("ontouchstart" in window)*/;var j=[];var d=false;function i(){if(d){requestAnimFrame(i);for(var n=0,m=j.length;n<m;n++){j[n].update();}}}function l(n,m){if(!n.nodeName||/^(ul|ol)$/i.test(n.nodeName)===false){return false;
